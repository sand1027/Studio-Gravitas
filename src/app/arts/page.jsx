    ...
    <>
      ...
      >
        <nav className="p-6 space-y-1">
          ...
          <a href="/arts" className="block py-0.5 text-sm font-normal transition-colors text-gray-800 no-underline" onClick={() => setMenuOpen(false)}>Arts</a>
      ...
      <aside className="hidden lg:block w-96 fixed h-screen z-50 pointer-events-none">
        ...
        <nav className="overflow-hidden pointer-events-auto">
          ...
          <a href="/objects" className="block -my-1 pl-8 text-lg font-normal transition-colors text-gray-700 opacity-60 hover:opacity-100 no-underline">Objects</a>
          <a href="/arts" className="block -my-1 pl-8 text-lg font-normal transition-colors text-gray-700 opacity-100 no-underline">Arts</a>
          <div className="mt-2">
