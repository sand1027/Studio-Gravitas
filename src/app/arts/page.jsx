    ...
    <>
      ...
      <aside className="hidden lg:block w-64 fixed h-screen z-50 pointer-events-none">
        ...
        <nav className="overflow-hidden pointer-events-auto">
          ...
          <a href="/objects" className="block py-0 pl-6 text-sm font-normal transition-colors text-gray-800 opacity-60 hover:opacity-100 no-underline">Objects</a>
          <a href="/arts" className="block py-0 pl-6 text-sm font-normal transition-colors text-gray-800 opacity-100 no-underline">Arts</a>
