      ...
      <div className="p-8 lg:p-12">
        <div className="content-text" style={{maxWidth: '38rem'}}>
          <div className="space-y-8 text-gray-600 leading-relaxed font-light">
            ...
            <p className="font-light">
              Beyond the program, client needs and contextual forces, every project is a journey—an investigation into design rooted in the spirit of a place, history and memory. At times, it is a typological exploration that seeks to redefine the idea of home and living and an opportunity to make a difference.
            </p>
